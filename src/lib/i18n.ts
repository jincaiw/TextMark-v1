...
const zh = {
  ...
  toolbarTitle: "自定工具栏", toolbarHint: "拖动项目调整顺序，点按项目可添加或移除。", availableItems: "可用项目", currentToolbar: "当前工具栏", reset: "恢复默认", done: "完成",
  flexibleSpace: "弹性空间", space: "空格", inspector: "简介", share: "共享", zoom: "缩放", searchItem: "搜索", printItem: "打印", copyItem: "复制", exportItem: "导出",
...
const en: Record<keyof typeof zh, string> = {
  ...
  toolbarTitle: "Customize Toolbar", toolbarHint: "Drag items to reorder them, or click an item to add or remove it.", availableItems: "Available Items", currentToolbar: "Current Toolbar", reset: "Restore Defaults", done: "Done",
  flexibleSpace: "Flexible Space", space: "Space", inspector: "Get Info", share: "Share", zoom: "Zoom", searchItem: "Search", printItem: "Print", copyItem: "Copy", exportItem: "Export",
