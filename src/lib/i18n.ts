...
const zh = {
  ...
  close: "关闭", minimize: "最小化", maximize: "缩放", copied: "已拷贝", copy: "拷贝", copyCode: "拷贝代码", copySource: "拷贝 Markdown 源文本",
  print: "打印…", exportHtml: "导出 HTML…", exportPng: "导出 PNG…", export: "导出", exportPdf: "导出 PDF",
  tableOfContents: "目录", projectNavigator: "项目导航器", noHeadings: "没有标题", project: "项目", settingsStored: "偏好设置仅保存在本设备。",
...
const en: Record<keyof typeof zh, string> = {
  ...
  close: "Close", minimize: "Minimize", maximize: "Zoom", copied: "Copied", copy: "Copy", copyCode: "Copy code", copySource: "Copy Markdown Source",
