...
const zh = {
  ...
  search: "在文稿中搜索", find: "查找", contains: "包含", beginsWith: "开头为", matchCase: "区分大小写",
  ...
  edit: "编辑", preview: "预览", sidebar: "边栏", chooseSidebar: "选择边栏模式", toggleSidebar: "显示或隐藏边栏", zoomOut: "缩小", zoomIn: "放大", open: "打开",
  ...
  openInNewTab: "在新标签页中打开", openInNewWindow: "在新窗口中打开", copyPath: "拷贝路径", copyContents: "拷贝内容",
...
const en: Record<keyof typeof zh, string> = {
  ...
  edit: "Edit", preview: "Preview", sidebar: "Sidebar", chooseSidebar: "Choose sidebar mode", toggleSidebar: "Toggle Sidebar", zoomOut: "Zoom Out", zoomIn: "Zoom In", open: "Open",
