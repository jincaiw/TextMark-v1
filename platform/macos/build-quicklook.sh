...
xcodebuild -project "$script_dir/TextMarkQuickLook.xcodeproj" -scheme TextMarkQuickLook -configuration Release -derivedDataPath "$derived_dir" ARCHS="arm64 x86_64" ONLY_ACTIVE_ARCH=NO CODE_SIGN_IDENTITY=- DEVELOPMENT_TEAM= CODE_SIGNING_ALLOWED=NO build
